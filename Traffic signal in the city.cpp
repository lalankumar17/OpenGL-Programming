//10.Program to create scene in 3D using unity/unreal/OpenGL
...
int main(int argc, char** argv) {
    ...
    cout << "KOTALO ASWINI \t\t 1NT22CS092" << endl;
    cout << "LALAN MAHATO  \t\t INT22CS098" << endl;
    cout << "YASHAS C RAJU  \t\t 1NT22CS217" << endl;
